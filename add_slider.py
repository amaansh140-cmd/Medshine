...
<section class="max-w-[100vw] overflow-hidden mb-28">
  <div class="flex overflow-x-auto snap-x snap-mandatory gap-6 px-6 md:px-10 pb-8 no-scrollbar" style="scroll-padding-left: 1.5rem; scroll-padding-right: 1.5rem;">
    ...
    <!-- Slide 1 -->
    <div class="snap-center shrink-0 w-[85vw] md:w-[60vw] lg:w-[50vw] h-[350px] md:h-[500px] relative rounded-[32px] overflow-hidden group">
...
for filename in target_files:
    if os.path.exists(filename):
        ...
        # Insert right before "<!-- Biography & Credentials Grid -->"
...
# Append no-scrollbar css to index.css
...
if '.no-scrollbar' not in css_content:
    ...
    if os.path.exists('../Medshine/src/index.css'):
        shutil.copy('src/index.css', '../Medshine/src/index.css')
